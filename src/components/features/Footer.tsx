      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          >
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 max-w-xs mb-6">
              Empowering clinicians with AI-driven genomic insights. Designed in San Francisco.
            </p>
          ...
          >
            ...
            <ul className="mt-4 space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.label}>
                  <a className="text-sm text-slate-600 hover:text-blue-600 dark:text-slate-400 transition-colors" href={link.href}>
                    {link.label}
                  </a>
                </li>
              ))}
        ...
        >
          <p className="text-xs text-slate-500 dark:text-slate-500">
            © 2023 Chroma-Pilot Inc. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
